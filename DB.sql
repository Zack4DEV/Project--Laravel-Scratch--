...
CREATE TABLE IF NOT EXISTS `migrations` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT= DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `failed_jobs` (
  ...
  `uuid` varchar(191) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `personal_access_tokens` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tokenable_type` varchar(191) COLLATE utf8_general_ci NOT NULL,
