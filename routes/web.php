...
Route::get('/', 'App\Http\Controllers\User@user_Signup_Up')->name('up_signup_user');
Route::post('/', 'App\Http\Controllers\User@user_Signup_In')->name('in_signup_user');
...
Route::group(
    ...
    function () {
        Route::middleware(['admin'])->group(
            function () {
                Route::get('/admin/logout', 'Employee@logout_Employee')->name('employee_logout');

                Route::get('/admin/dashboard', 'Employee@up_Login_Employee')->name('employee_login_up');
                Route::get('/admin/dashboard', 'Employee@dashboard_Employee_To')->name('to_employee_dashboard');
                ...
                Route::get('/admin/invoice', 'Invoice@Invoice_To')->name('to_invoice');
                ...
                Route::get('/admin/payment', 'Payment@payment_To')->name('to_payment');
                Route::get('/admin/payment/delete', 'Payment@payment_Delete_To')->name('to_delete_payment');
                ...
                Route::get('/admin/roombook/delete', 'Roombook@roombook_To_Delete')->name('delete_to_roombook');
