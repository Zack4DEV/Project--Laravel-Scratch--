    ...
    function () {
        Route::middleware(['auth:admin'])->group(
            function () {
                ...
                Route::post('/room', 'Room@room_To')->name('to_room');
                ...
                Route::post('/roombook', 'Roombook@roombook_To')->name('to_roombook');
